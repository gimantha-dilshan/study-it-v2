...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden z-10">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="space-y-4">
            ...
            <p className="max-w-xl mx-auto lg:mx-0 text-xl text-gray-400 font-medium leading-relaxed">
              Experience the ultimate AI study partner on WhatsApp. Multimodal problem solving, OCR, Voice interactions, and sub-second delivery.
            </p>
          </div>
        ...
        >
           ...
           <div className="relative w-full max-w-lg aspect-square lg:aspect-auto lg:h-[90%] rounded-[3rem] glass-card overflow-hidden shadow-[0_0_80px_rgba(99,102,241,0.2)] border border-white/20 transform hover:scale-[1.02] transition-transform duration-500">
               ...
               {/* UI Overlay Elements to make it look like a dashboard/chat */}
               <div className="absolute bottom-6 left-6 right-6 glass p-4 rounded-2xl border border-white/20 backdrop-blur-xl animate-float">
                  <div className="flex items-center gap-4">
                     ...
                     <div>
                        <p className="text-white font-bold text-sm tracking-tight">AI Solution Ready</p>
                        <p className="text-gray-400 text-xs">Delivered in 0.8s via Gemini 2.5</p>
                     </div>
                  </div>
               </div>
           </div>
